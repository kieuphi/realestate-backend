...
{
    public class GetNewsByCategoryQuery : IRequest<PaginatedList<ListNewsModel>>
    {
        public Guid CategoryId { set; get; }
        public PagingNewsModel PagingModel { set; get; }
    }

    public class GetNewsByCategoryQueryHandler : IRequestHandler<GetNewsByCategoryQuery, PaginatedList<ListNewsModel>>
    {
        private readonly IMapper _mapper;
        private readonly IApplicationDbContext _context;
        private readonly ICommonFunctionService _commonFunctionService;

        public GetNewsByCategoryQueryHandler(
            IMapper mapper,
        ...
        public async Task<PaginatedList<ListNewsModel>> Handle(GetNewsByCategoryQuery request, CancellationToken cancellationToken)
        {

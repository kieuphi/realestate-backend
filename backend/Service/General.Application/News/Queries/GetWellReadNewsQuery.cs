...
{
    public class GetWellReadNewsQuery : IRequest<PaginatedList<ListNewsModel>>
    {
        public PagingNewsModel PagingModel { set; get; }
    }

    public class GetWellReadNewsQueryHandler : IRequestHandler<GetWellReadNewsQuery, PaginatedList<ListNewsModel>>
    {
        private readonly IMapper _mapper;
        private readonly IApplicationDbContext _context;
        private readonly ICommonFunctionService _commonFunctionService;

        public GetWellReadNewsQueryHandler(
            IMapper mapper,
        ...
        public async Task<PaginatedList<ListNewsModel>> Handle(GetWellReadNewsQuery request, CancellationToken cancellationToken)
        {

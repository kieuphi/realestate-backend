...
{
    public class GetPropertyBySlugQuery : IRequest<PropertyModel>
    {
        public string Slug { set; get; }
        public bool IsAdmin { get; set; }
    }

    public class GetPropertyBySlugQueryHandler : IRequestHandler<GetPropertyBySlugQuery, PropertyModel>
    {
        ...
        public async Task<PropertyModel> Handle(GetPropertyBySlugQuery request, CancellationToken cancellationToken)
        {
            ...
            var result = await _context.Property
                    ...
                    .FirstOrDefaultAsync();
            if (result != null && request.IsAdmin == false)
            {

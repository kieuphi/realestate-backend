    ...
    public partial class createDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActiveCodeInformation", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(nullable: true),
                    RatingNumber = table.Column<decimal>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<int>(nullable: false),
                    CurrentState = table.Column<int>(nullable: false),
                    CategoryNameVi = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<int>(nullable: false),
                    CurrentState = table.Column<int>(nullable: false),
                    ProjectVi = table.Column<string>(nullable: true),
                    ProjectEn = table.Column<string>(nullable: true),
                    Descriptions = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyAddressVi = table.Column<string>(nullable: true),
                    PropertyAddressEn = table.Column<string>(nullable: true),
                    WebsiteDateOfPost = table.Column<DateTime>(nullable: true),
                    Title = table.Column<string>(nullable: true),
                    Descriptions = table.Column<string>(nullable: true),
                    LotSize = table.Column<decimal>(nullable: true),
                    Price = table.Column<decimal>(nullable: true),
                    CurrencyId = table.Column<string>(nullable: true),
                    BedroomId = table.Column<string>(nullable: true),
                    BathroomId = table.Column<string>(nullable: true),
                    FloorsNumber = table.Column<decimal>(nullable: true),
                    TotalBuildingFloors = table.Column<decimal>(nullable: true),
                    AmentitiesNearbyId = table.Column<string>(nullable: true),
                    YearCompleted = table.Column<DateTime>(nullable: true),
                    DateOfPost = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmenitiesNearbyId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyAmenitiesNearby", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "PropertyNumberCounter",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Date = table.Column<DateTime>(nullable: false),
                    TransactionType = table.Column<string>(nullable: true),
                    CurValue = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyNumberCounter", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attachment_ImageCategory_ImageCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<int>(nullable: false),
                    CurrentState = table.Column<int>(nullable: false),
                    TitleVi = table.Column<string>(nullable: true),
                    TitleEn = table.Column<string>(nullable: true),
                    Keyword = table.Column<string>(nullable: true),
                    ContentVi = table.Column<string>(nullable: true),
                    ContentEn = table.Column<string>(nullable: true),
                    DescriptionsVi = table.Column<string>(nullable: true),
                    DescriptionsEn = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachment_ImageCategoryId",
                table: "Attachment",

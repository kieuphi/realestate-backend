...
{
    public class PropertyFavoriteModel : AuditableModel
    {
    ...
    public class CreatePropertyFavoriteModel
    {
        public Guid UserId { set; get; }
        public Guid PropertyId { set; get; }
    }

    public class ListPropertyFavoriteModel
    {
        public Guid UserId { set; get; }
        public Guid PropertyId { set; get; }
    ...
    public class PagingPropertyFavoriteModel : PagingIndexModel
    {
        public Guid UserId { set; get; }
    }
}
